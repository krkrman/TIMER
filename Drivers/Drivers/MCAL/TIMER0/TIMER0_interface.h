...
enum TIMER0_Mode{NORMAL_MODE , PHASE_CORRECT_PWM , CTC_MODE , FAST_PWM};
...
enum TIMER0_Prescalar{NO_PRESCALAR , PRESCALAR_1 , PRESCALAR_8 , PRESCALAR_64 , PRESCALAR_256,PRESCALAR_1024,COUNTER_T0_FALLING_EDGE , COUNTER_T0_RISING_EDGE};
